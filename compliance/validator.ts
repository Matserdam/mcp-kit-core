...
export class MCPComplianceValidator {
  ...
  private async loadProtobufDefinitions(): Promise<void> {
    try {
      ...
      this.messageTypes.set(
        ...
        this.root.lookupType("mcp.ResourceTemplatesListResult"),
      );
      this.messageTypes.set(
        "NotificationAckResult",
        this.root.lookupType("mcp.NotificationAckResult"),
      );
      ...
      this.messageTypes.set(
        "WellKnownOAuthAuthorizationServerRequest",
        this.root.lookupType("mcp.WellKnownOAuthAuthorizationServerRequest"),
      );
      this.messageTypes.set(
        "WellKnownOAuthAuthorizationServerResponse",
        this.root.lookupType("mcp.WellKnownOAuthAuthorizationServerResponse"),
      );
      this.messageTypes.set(
        "WellKnownOAuthProtectedResourceRequest",
        this.root.lookupType("mcp.WellKnownOAuthProtectedResourceRequest"),
      );
      this.messageTypes.set(
        "WellKnownOAuthProtectedResourceResponse",
        this.root.lookupType("mcp.WellKnownOAuthProtectedResourceResponse"),
      );
      this.messageTypes.set(
        "CORSPreflightRequest",
        this.root.lookupType("mcp.CORSPreflightRequest"),
      );
      this.messageTypes.set(
        "CORSPreflightResponse",
        this.root.lookupType("mcp.CORSPreflightResponse"),
      );
      this.messageTypes.set(
        "DiscoveryConfiguration",
        this.root.lookupType("mcp.DiscoveryConfiguration"),
      );
      this.messageTypes.set(
        "AuthorizationServerConfig",
        this.root.lookupType("mcp.AuthorizationServerConfig"),
      );
      this.messageTypes.set(
        "ProtectedResourceConfig",
        this.root.lookupType("mcp.ProtectedResourceConfig"),
      );
      this.messageTypes.set(
        "AuthorizationServerMetadata",
        this.root.lookupType("mcp.AuthorizationServerMetadata"),
      );
      this.messageTypes.set(
        "ProtectedResourceMetadata",
        this.root.lookupType("mcp.ProtectedResourceMetadata"),
      );
  ...
  private validateMethodParams(method: string, params: unknown): ComplianceValidationResult {
    ...
    try {
      ...
      errors.push(
        `Parameter validation error: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  ...
  validateWellKnownEndpoint(endpoint: string, metadata: unknown): ComplianceValidationResult {
    ...
    if (endpoint === "/.well-known/oauth-authorization-server") {
      ...
      if (
        meta.resource_indicators_supported === undefined ||
        typeof meta.resource_indicators_supported !== "boolean"
      ) {
      ...
      if (!meta.authorization_servers || !Array.isArray(meta.authorization_servers)) {
        ...
        const nonStrings = (meta.authorization_servers as unknown[]).filter((v) =>
          typeof v !== "string"
        );
  ...
  validateWellKnownResponse(response: unknown): ComplianceValidationResult {
    ...
    if (
      resp.body !== undefined && !(resp.body instanceof Buffer) && typeof resp.body !== "string"
    ) {
  ...
  validateDiscoveryConfiguration(config: unknown): ComplianceValidationResult {
    ...
    if (
      cfg.enable_discovery_endpoints !== undefined &&
      typeof cfg.enable_discovery_endpoints !== "boolean"
    ) {
