  ...
  describe("Resource Indicators (RFC 8707)", () => {
    ...
    it("should reject invalid resource URIs", () => {
      const invalidUris = [
        ...
        {
          uri: "not-a-uri",
          expectedError: "Resource URI must include a scheme (e.g., https://, mcp://)",
        },
        {
          uri: "https://example.com#fragment",
          expectedError: "Resource URI must not contain fragment (#)",
        },
        {
          uri: "https://example.com/path with spaces",
          expectedError: "Resource URI must not contain spaces",
        },
      ];
