...
const createForbiddenToolkit = (namespace: string): MCPToolkit<unknown, { user: string }> => {
  ...
  return {
    ...
    resources: [{
      ...
      read: () => ({
        contents: [{ uri: "forbidden://resource", text: "forbidden resource content" }],
      }),
    } as MCPResourceProvider<unknown>],
    resourceTemplates: [{
      descriptor: {
      ...
      read: (uri: string) => ({
        contents: [{ uri: uri as `${string}://${string}`, text: "forbidden template content" }],
      }),
    } as MCPResourceTemplateProvider<unknown>],
    prompts: [{
      ...
      messages: () =>
        Promise.resolve([{
          role: "user",
          content: [{ type: "text", text: "forbidden prompt message" }],
        }]),
    } as unknown as MCPPromptDef<unknown, unknown>],
  };
};
