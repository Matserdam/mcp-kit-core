...
describe("MCP resources", () => {
      ...
      toolkits: [
        {
          ...
          resources: [
            createMCPResourceProvider({
              ...
              name: "a",
              read() {
                return { contents: [{ uri: "https://example.com/a", text: "A" }] };
              },
            }),
            createMCPResourceProvider({
              ...
              name: "b",
              read() {
                return { contents: [{ uri: "https://example.com/b", text: "B" }] };
              },
            }),
          ],
        },
      ...
      toolkits: [
        {
          ...
          resources: [
            createMCPResourceProvider({
              ...
              name: "res",
              read() {
                return { contents: [{ uri: "https://example.com", text: "hello" }] };
              },
            }),
          ],
        },
  ...
  it("resources/read resolves via template when provider not found", async () => {
    ...
    const resp = await jsonrpc(server, {
      ...
      id: 5,
      method: "resources/read",
      params: { uri: "https://example.com/123" },
    });
    const response = resp as { result: { contents: Array<{ text: string }> } };
