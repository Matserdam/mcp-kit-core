import type { MCPResponse, MCPResourceTemplatesListResult } from '../../../types/server.d.ts';
import type { MCPToolkit, MCPResourceTemplateProvider } from '../../../types/toolkit.d.ts';
